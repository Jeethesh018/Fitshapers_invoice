    ...
    <div className="glass-card overflow-hidden p-3">
      ...
      >
        <div className="relative min-h-[560px] rounded-[26px] border-2 border-zinc-900/90 p-4 sm:p-7">
          <img src="/1000135832-Photoroom.png" alt="FitShapers watermark" className="pointer-events-none absolute left-1/2 top-1/2 w-[52%] -translate-x-1/2 -translate-y-4/2 opacity-[0.06]" />
