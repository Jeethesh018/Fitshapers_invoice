          ...
          <div className="relative z-10 flex h-full flex-col justify-between gap-5">
            <div>
              ...
              <div className="mb-6 grid grid-cols-[1fr_auto_1fr] items-center gap-3 text-sm font-semibold">
                ...
                <h2 className="mx-auto inline-flex h-9 min-w-[150px] -translate-y-6 items-center justify-center rounded-full border-2 border-zinc-900 px-6 font-pop text-xl font-black tracking-wide text-zinc-900">RECEIPT</h2>
