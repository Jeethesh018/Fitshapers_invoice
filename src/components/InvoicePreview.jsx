    ...
    <div className="glass-card overflow-hidden p-3">
      ...
      >
        <div className="relative min-h-[560px] rounded-[26px] border-2 border-zinc-900/90 p-4 sm:p-7">
          <img src="/1000135832-Photoroom.png" alt="FitShapers watermark" className="pointer-events-none absolute left-1/2 top-1/2 w-[52%] -translate-x-1/2 -translate-y-1/2 opacity-[0.06]" />
          ...
          <div className="relative z-10 flex h-full flex-col justify-between gap-5">
            <div>
              ...
              <div className="mb-6 grid grid-cols-[1fr_auto_1fr] items-center gap-3 text-sm font-semibold">
                ...
                <h2 className="mx-auto inline-flex h-9 min-w-[150px] -translate-y-1 items-center justify-center rounded-full border-2 border-zinc-900 px-6 font-pop text-xl font-black tracking-wide text-zinc-900">RECEIPT</h2>
